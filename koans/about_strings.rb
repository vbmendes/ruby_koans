...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    #
    # The plus equals operator (+=) instantiates a copy of the object
    # and concatenates the other string. The shovel operator (<<) only
    # concatenates the other string to the already instantiated one.
  end
